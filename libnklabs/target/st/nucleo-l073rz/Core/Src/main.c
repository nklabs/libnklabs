...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : ARD_A0_Pin ARD_A1_Pin ARD_A2_Pin ARD_D7_Pin
                           ARD_D8_Pin */
  GPIO_InitStruct.Pin = ARD_A0_Pin|ARD_A1_Pin|ARD_A2_Pin|ARD_D7_Pin
                          |ARD_D8_Pin;
  ...
  /*Configure GPIO pins : ARD_A3_Pin ARD_A4_Pin ARD_A5_Pin ARD_D6_Pin
                           ARD_D3_Pin ARD_D5_Pin ARD_D4_Pin */
  GPIO_InitStruct.Pin = ARD_A3_Pin|ARD_A4_Pin|ARD_A5_Pin|ARD_D6_Pin
                          |ARD_D3_Pin|ARD_D5_Pin|ARD_D4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
